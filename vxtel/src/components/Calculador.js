 ...
 useEffect(()=>{
    ...
    return ( 
       <div className="container" id='calculadora'>
        ...
        <div className=" mx-auto bg-dark w-100 my-5 p-4">
            <h4 className='text-info font-weight-bold text-center'>Comparar Vantagem do Plano</h4>
            <form className='form py-4'  onSubmit={handleSubmit}>
                ...
                <strong>    Com FaleMais  </strong> {dados.comFaleMais}
                <strong>   Sem FaleMais  </strong> {dados.SemFaleMais} 
                {console.log(dados)}
                ...
                <button type='submit' className='btn btn-info btn-block mt-4' onProgress={handleSubmit}>Calcular</button>
            </form>
        </div>
        </div>
        </div>
